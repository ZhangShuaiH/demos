...
inline const std::string& Hello::email() const {
  // @@protoc_insertion_point(field_get:Hello.email)
  return _internal_email();
}
inline void Hello::set_email(const std::string& value) {
  _internal_set_email(value);
  // @@protoc_insertion_point(field_set:Hello.email)
}
inline std::string* Hello::mutable_email() {
  // @@protoc_insertion_point(field_mutable:Hello.email)
...
inline void Hello::set_email(std::string&& value) {
  ...
  email_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Hello.email)
}
inline void Hello::set_email(const char* value) {
  ...
  email_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:Hello.email)
}
inline void Hello::set_email(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  email_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Hello.email)
}
...
inline std::string* Hello::release_email() {
  // @@protoc_insertion_point(field_release:Hello.email)
...
inline void Hello::set_allocated_email(std::string* email) {
  ...
  email_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), email,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Hello.email)
}
inline std::string* Hello::unsafe_arena_release_email() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Hello.email)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return email_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Hello::unsafe_arena_set_allocated_email(
    std::string* email) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (email != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  email_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      email, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Hello.email)
}
